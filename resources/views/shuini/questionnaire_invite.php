                    ...
                    <div class="box box-body box-primary">
                        <div id="inviteList_wrapper" class="dataTables_wrapper form-inline dt-bootstrap no-footer">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-12">
                                    <table id="inviteList" class="table table-hover table-responsive dataTable no-footer" role="grid" aria-describedby="inviteList_info" style="width: 1050px;">
                                    <thead>
                                        <tr role="row"><th class="sorting_disabled" rowspan="1" colspan="1" style="width: 35px;">编号</th>
