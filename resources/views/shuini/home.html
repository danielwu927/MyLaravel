        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a class="active-menu" href="#"><i class="fa fa-dashboard "></i>主面板</a>
                    </li>
                    <li>
                    ...
                    <div class="col-md-6">
                        <div class="main-box mb-dull">
                            <a href="#">
                                ...
                                <a href="yh_manage.html"><h5>用户管理</h5></a>
                            </a>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="main-box mb-dull">
                            <a href="#">
                                ...
                                <a href="wj_template.html"><h5 >问卷模板管理</h5></a>
                            </a>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="main-box mb-dull">
                            <a href="#">
                                ...
                                <a href="jk_list.html"><h5>权限控制</h5></a>
                            </a>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="main-box mb-dull">
                            <a href="#">
                                ...
                                <a href="xt_parameter.html"><h5>系统管理</h5></a>
                            </a>
                        </div>
                    </div>
                </div><!-- row -->
